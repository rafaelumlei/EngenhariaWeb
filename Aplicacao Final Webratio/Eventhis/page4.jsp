...
<th class=" header"></th> 
				...
				<c:forEach var="current" varStatus="status" items="${pwu2.data}">
					<c:set var="index" value="${status.index}"/>	
		 			...
		 			<a title="Ver Evento Detalhado" id="ln114" class=" linkCurrentAlternate" href="<webratio:Link link="ln114" position="index"/>">
					Ver Evento Detalhado</a>
														</c:when>
														<c:otherwise>
		 			<a title="Ver Evento Detalhado" id="ln114" class=" linkCurrent" href="<webratio:Link link="ln114" position="index"/>">
					Ver Evento Detalhado</a>
														</c:otherwise>
							   						</c:choose>
							   				</c:when>
							   				<c:otherwise>
							   						<c:choose>
							   							<c:when test="${index mod 2 eq 0}">
		 			<a title="Ver Evento Detalhado" id="ln114" class=" linkAlternate" href="<webratio:Link link="ln114" position="index"/>">
					Ver Evento Detalhado</a>
														</c:when>
														<c:otherwise>
		 			<a title="Ver Evento Detalhado" id="ln114" class=" link" href="<webratio:Link link="ln114" position="index"/>">
					Ver Evento Detalhado</a>
														</c:otherwise>
							   						</c:choose>
							   				</c:otherwise>
