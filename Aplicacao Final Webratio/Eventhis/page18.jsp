...
<script type="text/javascript"
  ...
  function posicaoMarcaAlterada()
  {
	...
	document.getElementById("fld64_locale").value = centro.lat();
    document.getElementById("fld65_locale").value = centro.lng();
  }
  ...
  <body onload="initialize()">
	<div id="_wr_page" title="Eventhis;sv4#area3#page18"></div>
<html:form action="form_page18.do" styleId="page18FormBean" enctype="multipart/form-data">
  <div id="page18HiddenFields" >
    ...
    <input type="hidden" name="ln103" value="<webratio:Link link="ln103" />">
  </div>
 ...
 <a class="shortcuts" href="<webratio:Link link="ln106"/>">
   Voltar
</a>
			</c:if>
                        </td>
                        <td nowrap="nowrap" valign="bottom" style="padding-left:5px">
                          <c:if test="${webratio:isTargetAccessible('ln107', pageContext)}">	
 <a class="shortcuts" href="<webratio:Link link="ln107"/>">
   Log Out
</a>
			</c:if>
                        </td>
				...
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln103'); return false;}"  size="25" styleId="fld60" styleClass=" field" property="fld60" readonly="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld60"/></span>
</td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld61" styleClass=" field" cols="35" rows="8" property="fld61" readonly="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld61"/></span>
</td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:select onkeypress="if(event.keyCode==13){clickButton('ln103'); return false;}" styleId="sfld6" styleClass=" selectionfield" property="sfld6" disabled="false">
			  		<html:option value=""><bean:message key="selectionfield.noselection"/></html:option>
			  <html:options property="sfld6List" labelProperty="sfld6LabelList"/>
			</html:select>
						</td>
								<td class="error">
<span class=" error"><html:errors property="sfld6"/></span>
</td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln103'); return false;}"  size="25" styleId="fld63_locale" styleClass=" field" property="fld63_locale" readonly="false"/>
			<c:choose><c:when test="false">
				<img src="WRResources/calendar/calendar_disabled.gif" />
			</c:when><c:otherwise>
				<img src="WRResources/calendar/calendar.gif" id="fld63_locale_calendar" style="cursor: pointer"/>
				<script type="text/javascript">				
				  Calendar.setup(
				    {
				      inputField  : "fld63_locale",
				      ...
				      showsTime : "true"
								...
								<td class="error">
<span class=" error"><html:errors property="fld63_locale"/></span>
</td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln103'); return false;}"  size="25" styleId="fld62_locale" styleClass=" field" property="fld62_locale" readonly="false"/>
			<c:choose><c:when test="false">
				<img src="WRResources/calendar/calendar_disabled.gif" />
			</c:when><c:otherwise>
				<img src="WRResources/calendar/calendar.gif" id="fld62_locale_calendar" style="cursor: pointer"/>
				<script type="text/javascript">				
				  Calendar.setup(
				    {
				      inputField  : "fld62_locale",
				      ifFormat    : "<bean:message key="timestampCalendarPattern"/>",
				      firstDay    : <%= java.util.Calendar.getInstance((java.util.Locale) session.getAttribute(org.apache.struts.Globals.LOCALE_KEY)).getFirstDayOfWeek() - 1 %>,
				      button      : "fld62_locale_calendar",
				      onClose     : forceFieldBlur,
				      showsTime : "true"
				    }
				  );
								...
								<td class="error">
<span class=" error"><html:errors property="fld62_locale"/></span>
</td>
					 	</tr>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln103'); return false;}"  size="25" styleId="fld64_locale" styleClass=" field" property="fld64_locale" readonly="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld64_locale"/></span>
</td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln103'); return false;}"  size="25" styleId="fld65_locale" styleClass=" field" property="fld65_locale" readonly="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld65_locale"/></span>
</td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:radio onkeypress="if(event.keyCode==13){clickButton('ln103'); return false;}" styleClass=" field" property="fld66_locale" value="true" disabled="false"/>
				<bean:message key="boolean.yes"/>
				<html:radio onkeypress="if(event.keyCode==13){clickButton('ln103'); return false;}" styleClass=" field" property="fld66_locale" value="false" disabled="false"/>
				<bean:message key="boolean.no"/>
		<c:if test="false">
			<html:hidden property="fld66_locale"/>
		</c:if>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld66_locale"/></span>
</td>
					 	</tr>
					<tr>
						<td colspan="3">
					<table>
				      <tr>
			<c:if test="${webratio:isTargetAccessible('ln103', pageContext)}">
					  <td> 
		<c:if test="${webratio:isTargetAccessible('ln103', pageContext)}">
			<input title="Criar" onclick="$('page18FormBean').target='_self'" class=" button"  id="button:ln103" name="button:ln103" type="submit" value="Criar">
	</c:if>
 </td>
			</c:if>
					</tr>
