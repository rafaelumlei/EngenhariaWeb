...
<link href="wr-css/global.css" type="text/css" rel="stylesheet"><link href="wr-css/menu.css" type="text/css" rel="stylesheet"><link href="wr-css/units.css" type="text/css" rel="stylesheet">
  ...
  <body>
	<div id="_wr_page" title="Eventhis;sv2#page5"></div>
<html:form action="form_page5.do" styleId="page5FormBean" enctype="multipart/form-data">
  <div id="page5HiddenFields" >
    <html:hidden property="lastURL"/>
    <input type="hidden" name="conditions" value="${conditions}" id="conditions">
    <input type="hidden" name="ln16" value="<webratio:Link link="ln16" />">
    <input type="hidden" name="ln119" value="<webratio:Link link="ln119" />">
  </div>
 ...
 <a class="shortcuts" href="<webratio:Link link="ln116"/>">
   Voltar
</a>
                        </td>
                    </tr>
				...
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln16|ln119'); return false;}"  size="25" styleId="fld34" styleClass=" field" property="fld34" readonly="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld34"/></span>
</td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:password onkeypress="if(event.keyCode==13){clickButton('ln16|ln119'); return false;}" styleId="fld35" size="25" styleClass=" field" property="fld35" readonly="false" redisplay="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld35"/></span>
</td>
					 	</tr>
					<tr>
						<td colspan="3">
					<table>
				      <tr>
					  <td> 
			<input title="Log In" onclick="$('page5FormBean').target='_self'" class=" button"  id="button:ln16" name="button:ln16" type="submit" value="Log In">
 </td>
					  <td> 
			<input title="Sign Up" onclick="$('page5FormBean').target='_self'" class=" button"  id="button:ln119" name="button:ln119" type="submit" value="Sign Up">
 </td>
					</tr>
				    </table>
				   </td>
...
<script type="text/javascript">
	$("page5FormBean").observe("wr:pageFocus", function(e) {
