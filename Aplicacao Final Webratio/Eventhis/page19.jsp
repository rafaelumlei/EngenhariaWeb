...
<link href="wr-css/global.css" type="text/css" rel="stylesheet"><link href="wr-css/menu.css" type="text/css" rel="stylesheet"><link href="wr-css/units.css" type="text/css" rel="stylesheet">
  ...
  <body>
	<div id="_wr_page" title="Eventhis;sv2#area4#page19"></div>
<html:form action="form_page19.do" styleId="page19FormBean" enctype="multipart/form-data">
  <div id="page19HiddenFields" >
 ...
 <a class="shortcuts" href="<webratio:Link link="ln111"/>">
   Voltar
</a>
                        </td>
                    </tr>
			...
			<div class="plain PowerIndexUnit">
				...
				<c:forEach var="current" varStatus="status" items="${pwu4.data}">
					<c:set var="index" value="${status.index}"/>	
							<tr>
										<td rowspan="3" class=" value<c:if test="${pwu4.currentIndex eq index}">Current</c:if> string">				
													<c:out value="${current.titulo}"/>
											   </td>
								</tr>
							<tr>
										<td style="background:#F1F1F1" class=" value<c:if test="${pwu4.currentIndex eq index}">Current</c:if> text">				
...
<script type="text/javascript">
	$("page19FormBean").observe("wr:pageFocus", function(e) {
