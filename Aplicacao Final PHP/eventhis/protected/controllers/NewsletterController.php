...
class NewsletterController extends Controller
{
	...
	public function actionIndex()
	{
		...
		{                
                        ...
                        $modelE = Evento::model();
                        $eventos = $modelE->getEventosProxNewsletterIt();
                        $criteria = new CDbCriteria();
                        // identificar o nr da última newsletter inserida
                        $sql = "select MAX(nr) FROM newsletter;";
                        $max=Yii::app()->db->createCommand($sql)->execute();
                ...
                $this->render('index',array(
                        'data'=>$model->getEventosProxNewsletter(10),
                ));
	}
