...
<% {
  ...
  function areaAlterada()
  {
	...
	document.getElementById("fld6_locale").value = sw.lat();
    document.getElementById("fld7_locale").value = sw.lng();
	document.getElementById("fld8_locale").value = ne.lat();
    document.getElementById("fld9_locale").value = ne.lng();	
  }
...
<span class=" error"><html:errors property="fld28"/></span>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln9'); return false;}"  size="25" styleId="fld23" styleClass=" field" property="fld23" readonly="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld23"/></span>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value"> <br /><br /><br />
