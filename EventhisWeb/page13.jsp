...
<link href="wr-css/global.css" type="text/css" rel="stylesheet"><link href="wr-css/menu.css" type="text/css" rel="stylesheet"><link href="wr-css/units.css" type="text/css" rel="stylesheet">
  ...
  <body>
	<div id="_wr_page" title="Eventhis;sv2#page13"></div>
<html:form action="form_page13.do" styleId="page13FormBean" enctype="multipart/form-data">
  <div id="page13HiddenFields" >
    ...
    <input type="hidden" name="ln10" value="<webratio:Link link="ln10" />">
  </div>
				...
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln10'); return false;}"  size="25" styleId="fld26" styleClass=" field" property="fld26" readonly="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld26"/></span>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:password onkeypress="if(event.keyCode==13){clickButton('ln10'); return false;}" styleId="fld27" size="25" styleClass=" field" property="fld27" readonly="false" redisplay="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld27"/></span>
					...
					<table>
				      <tr>
					  <td> 
			<input title="Log In" onclick="$('page13FormBean').target='_self'" class=" button"  id="button:ln10" name="button:ln10" type="submit" value="Log In">
 </td>
					</tr>
				    </table>
				   </td>
