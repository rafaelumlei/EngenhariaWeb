...
<html:form action="form_page5.do" styleId="page5FormBean" enctype="multipart/form-data">
  <div id="page5HiddenFields" >
    ...
    <input type="hidden" name="ln17" value="<webratio:Link link="ln17" />">
  </div>
 ...
 <a class="shortcuts" href="<webratio:Link link="ln19"/>">
   Voltar
</a>
                        </td>
                    </tr>
				...
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text onkeypress="if(event.keyCode==13){clickButton('ln16|ln17'); return false;}"  size="25" styleId="fld34" styleClass=" field" property="fld34" readonly="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld34"/></span>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:password onkeypress="if(event.keyCode==13){clickButton('ln16|ln17'); return false;}" styleId="fld35" size="25" styleClass=" field" property="fld35" readonly="false" redisplay="false"/>
						</td>
								<td class="error">
<span class=" error"><html:errors property="fld35"/></span>
			...
			<input title="Log In" onclick="$('page5FormBean').target='_self'" class=" button"  id="button:ln16" name="button:ln16" type="submit" value="Log In">
					  ...
					  <td> 
			<input title="Sign Up" onclick="$('page5FormBean').target='_self'" class=" button"  id="button:ln17" name="button:ln17" type="submit" value="Sign Up">
 </td>
					</tr>
				    </table>
				   </td>
