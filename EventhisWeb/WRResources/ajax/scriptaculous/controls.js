...
var Autocompleter = { };
/* WR bug 3677 */
Autocompleter._instances = {};
Autocompleter.getInstance = function(element) {
	return Autocompleter._instances[$(element).identify()];	
};
/* WR end */
Autocompleter.Base = Class.create({
  baseInitialize: function(element, update, options) {
    ...
    /* WR bug 3677 */
    Autocompleter._instances[element.identify()] = this;
    /* WR end */
  },
